...
class PPCP_Paypal_Checkout_For_Woocommerce_Gateway extends WC_Payment_Gateway_CC {
    ...
    public function admin_options() {
        ...
        echo '</span>';
        echo '<small style="font-size:16px;">';
        echo wp_kses(
                __('<a href="https://wordpress.org/support/plugin/woo-paypal-gateway/" target="_blank" style="text-decoration:underline;color:#2271b1;font-weight: 500;">Support</a>', 'woo-paypal-gateway'),
    ...
    public function output_tabs($current_tab) {
        $tabs = array(
            ...
            'wpg_recommended_plugins' => __('Recommended Plugins', 'woo-paypal-gateway'),
        );
                    ...
                    <div class="wpg_foq">
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-answer">
                                ...
                                <ol>
                                    <li><?php echo wp_kses_post(__('Go to <strong>PayPal Settings</strong>.', 'woo-paypal-gateway')); ?></li>
                        ...
                        <div class="faq-item">
                            ...
                            <div class="faq-answer">
                                ...
                                <h4><?php echo esc_html__('Step 1: Update PayPal Settings', 'woo-paypal-gateway'); ?></h4>
                                <ol>
                                    <li><?php echo wp_kses_post(__('Go to <strong>PayPal Settings > Checkout Page Settings</strong>.', 'woo-paypal-gateway')); ?></li>

...
class PPCP_Paypal_Checkout_For_Woocommerce_Subscriptions_CC extends PPCP_Paypal_Checkout_For_Woocommerce_Gateway_CC {
        ...
        if (!empty($subscriptions)) {
            foreach ($subscriptions as $subscription) {
                ...
                if (is_a($subscription_parent, WC_Subscription::class)) {
                    $wpg_used_payment_method = $subscription_parent->get_meta('_wpg_ppcp_used_payment_method');
    ...
    public function free_signup_with_token_payment_tokenization($order_id) {
        if (!empty($_POST['wc-wpg_paypal_checkout_cc-token']) && $_POST['wc-wpg_paypal_checkout_cc-token'] != 'new') {
